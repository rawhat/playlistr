...
var _user$project$Main$socketServer = 'ws://localhost:8880/playlist/socket';
var _user$project$Main$myButton = A2(
	_elm_lang$html$Html$div,
	_elm_lang$core$Native_List.fromArray(
		[]),
	_elm_lang$core$Native_List.fromArray(
		[]));
var _user$project$Main$exportPlaylistLink = function (model) {
	var songUrls = function () {
		var _p0 = model.selectedPlaylist;
		if (_p0.ctor === 'Nothing') {
			return '';
		} else {
			var _p1 = _p0._0;
			return (_elm_lang$core$Native_Utils.cmp(
				_elm_lang$core$List$length(_p1.songs),
				0) > 0) ? A2(
				_elm_lang$core$String$join,
				',',
				A2(
	...
	return _elm_lang$core$Native_Utils.eq(songUrls, '') ? A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				A2(_elm_lang$core$Basics_ops['++'], 'http://youtube.com/watch_videos?video_ids=', songUrls)),
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('glyphicon glyphicon-export')
					]),
				_elm_lang$core$Native_List.fromArray(
					[]))
			]));
};
var _user$project$Main$encodeNewPlaylist = function (playlist) {
	var playlistType = function () {
		var _p2 = playlist.playlistType;
		if (_p2.ctor === 'Audio') {
			return 'audio';
		} else {
			return 'video';
	...
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				...
				ctor: '_Tuple2',
				_0: 'playlist',
				_1: _elm_lang$core$Json_Encode$string(playlist.title)
			},
				{
				ctor: '_Tuple2',
				_0: 'category',
				_1: _elm_lang$core$Json_Encode$string(playlist.category)
			},
				{
				ctor: '_Tuple2',
				_0: 'password',
				_1: _elm_lang$core$Json_Encode$string(playlist.password)
			},
				{
				ctor: '_Tuple2',
				_0: 'type',
				_1: _elm_lang$core$Json_Encode$string(playlistType)
			},
				{
				ctor: '_Tuple2',
				_0: 'openSubmissions',
				_1: _elm_lang$core$Json_Encode$bool(playlist.$public)
			}
			]));
};
var _user$project$Main$createPlaylistRequest = function (model) {
	return A3(
		_lukewestby$elm_http_builder$HttpBuilder$send,
		_lukewestby$elm_http_builder$HttpBuilder$jsonReader(_elm_lang$core$Json_Decode$string),
		...
		A3(
			...
			A2(
				...
				_user$project$Main$encodeNewPlaylist(model.newPlaylist),
				_lukewestby$elm_http_builder$HttpBuilder$post('http://localhost:8880/playlist/create'))));
};
var _user$project$Main$serverUrl = 'http://localhost:8880';
var _user$project$Main$mediaMessage = _elm_lang$core$Native_Platform.outgoingPort(
	'mediaMessage',
	function (v) {
		return v;
	});
var _user$project$Main$sendMessage = _elm_lang$core$Native_Platform.incomingPort('sendMessage', _elm_lang$core$Json_Decode$string);
var _user$project$Main$Model = F8(
	function (a, b, c, d, e, f, g, h) {
		return {playlists: a, selectedPlaylist: b, currentPlaytime: c, paused: d, currentSong: e, addedSong: f, newPlaylist: g, modalShowing: h};
	});
						...
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return {title: a, category: b, password: c, openSubmissions: d, playlistType: e, length: f, currentTime: g, isPaused: h, currentSongIndex: i, songs: j, hasPlayed: k};
										};
									};
								};
							};
...
var _user$project$Main$NewPlaylist = F5(
	function (a, b, c, d, e) {
		return {title: a, category: b, playlistType: c, password: d, $public: e};
	});
var _user$project$Main$Song = F6(
	function (a, b, c, d, e, f) {
		return {info: a, isVideo: b, url: c, length: d, streamUrl: e, expanded: f};
	});
var _user$project$Main$songDecoder = A4(
			...
			A3(
				...
				A3(
					...
					A3(
						...
						'info',
						_elm_lang$core$Json_Decode$string,
						_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Main$Song)))))));
var _user$project$Main$NewSong = F2(
	function (a, b) {
		return {playlist: a, url: b};
	});
var _user$project$Main$Message = F2(
	function (a, b) {
		return {action: a, time: b};
	});
var _user$project$Main$audioDecoder = A4(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
	'time',
	_elm_lang$core$Json_Decode$float,
	-1.0,
...
var _user$project$Main$PlaylistsRecord = function (a) {
	return {playlists: a};
};
var _user$project$Main$PlaylistRecord = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
						...
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return {title: a, category: b, password: c, openSubmissions: d, playlistType: e, length: f, currentTime: g, isPaused: h, currentSongIndex: i, hasPlayed: j, songs: k};
										};
									};
								};
							};
...
var _user$project$Main$playlistDecoder = A4(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
	'songs',
	_elm_lang$core$Json_Decode$list(_user$project$Main$songDecoder),
	_elm_lang$core$Native_List.fromArray(
		[]),
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
								...
								A3(
									...
									A3(
										...
										A3(
											...
											'title',
											_elm_lang$core$Json_Decode$string,
											_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Main$PlaylistRecord))))))))))));
var _user$project$Main$playlistsDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'playlists',
	_elm_lang$core$Json_Decode$list(_user$project$Main$playlistDecoder),
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Main$PlaylistsRecord));
var _user$project$Main$SongRecord = F5(
	function (a, b, c, d, e) {
		return {info: a, isVideo: b, url: c, length: d, streamUrl: e};
	});
var _user$project$Main$Video = {ctor: 'Video'};
var _user$project$Main$Audio = {ctor: 'Audio'};
var _user$project$Main$CreatePlaylistSuccess = function (a) {
	return {ctor: 'CreatePlaylistSuccess', _0: a};
};
var _user$project$Main$CreatePlaylistFail = function (a) {
	return {ctor: 'CreatePlaylistFail', _0: a};
};
var _user$project$Main$AddSongSuccess = function (a) {
	return {ctor: 'AddSongSuccess', _0: a};
};
var _user$project$Main$AddSongFail = function (a) {
	return {ctor: 'AddSongFail', _0: a};
};
var _user$project$Main$update = F2(
	function (action, model) {
		var _p3 = action;
		switch (_p3.ctor) {
			case 'GetPlaylistsFail':
				var error = A2(_elm_lang$core$Debug$log, 'err', _p3._0);
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			case 'GetPlaylistsSuccess':
				var updatedPlaylists = A2(_elm_lang$core$Json_Decode$decodeString, _user$project$Main$playlistsDecoder, _p3._0);
				var playlists = function () {
					var _p4 = updatedPlaylists;
					if (_p4.ctor === 'Ok') {
						return A2(
							_elm_lang$core$List$map,
							function (playlist) {
								return _user$project$Main$Playlist(playlist.title)(playlist.category)(playlist.password)(playlist.openSubmissions)(
									function () {
										var _p5 = playlist.playlistType;
										switch (_p5) {
											case 'audio':
												return _user$project$Main$Audio;
											case 'video':
												return _user$project$Main$Video;
											default:
												return _user$project$Main$Audio;
										}
									}())(playlist.length)(playlist.currentTime)(playlist.isPaused)(playlist.currentSongIndex)(playlist.songs)(playlist.hasPlayed);
							},
							_p4._0.playlists);
					} else {
						return _elm_lang$core$Native_List.fromArray(
			...
			case 'UpdatePlaylistType':
				var playlist = model.newPlaylist;
				var updatedPlaylist = _elm_lang$core$Native_Utils.update(
					playlist,
					{playlistType: _p3._0});
				return {
					ctor: '_Tuple2',
			...
			case 'UpdatePlaylistPublicStatus':
				var playlist = model.newPlaylist;
				var updatedPlaylist = _elm_lang$core$Native_Utils.update(
					playlist,
					{
						$public: _elm_lang$core$Basics$not(playlist.$public)
					});
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
			...
			case 'CreatePlaylist':
				...
				var msg = A2(
					...
					_evancz$elm_http$Http$string(
						_elm_lang$core$Basics$toString(newPlaylistRecord)));
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							newPlaylist: A5(_user$project$Main$NewPlaylist, '', '', _user$project$Main$Audio, '', true)
						}),
					_1: A3(
						_elm_lang$core$Task$perform,
						_user$project$Main$CreatePlaylistFail,
						_user$project$Main$CreatePlaylistSuccess,
						_user$project$Main$createPlaylistRequest(model))
				};
			case 'CreatePlaylistFail':
				var msg = A2(
					_elm_lang$core$Debug$log,
					'err',
			...
			case 'SelectPlaylist':
				var _p8 = _p3._0;
				var _p7 = model.selectedPlaylist;
				if (_p7.ctor === 'Nothing') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								selectedPlaylist: _elm_lang$core$Maybe$Just(_p8)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return _elm_lang$core$Native_Utils.eq(_p8, _p7._0) ? {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{selectedPlaylist: _elm_lang$core$Maybe$Nothing}),
						_1: _elm_lang$core$Platform_Cmd$none
					} : {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
			...
			case 'SocketMessage':
				var data = A2(_elm_lang$core$Debug$log, 'data', _p3._0);
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			case 'InputSong':
				return {
					ctor: '_Tuple2',
			...
			case 'TogglePlaylistForm':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							modalShowing: _elm_lang$core$Basics$not(model.modalShowing)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'AddSong':
				if (_elm_lang$core$Native_Utils.eq(model.addedSong, '')) {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				} else {
					var newSong = A2(_elm_lang$core$Debug$log, 'test', model.addedSong);
					var _p9 = model.selectedPlaylist;
					if (_p9.ctor === 'Just') {
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
							...
							_1: A3(
								_elm_lang$core$Task$perform,
								_user$project$Main$AddSongFail,
								_user$project$Main$AddSongSuccess,
								A3(
									_evancz$elm_http$Http$post,
									_elm_lang$core$Json_Decode$int,
									A2(_elm_lang$core$Basics_ops['++'], _user$project$Main$serverUrl, '/song/new'),
									_evancz$elm_http$Http$string(
										A2(
											_elm_lang$core$Basics_ops['++'],
											'{ \"playlist\": \"',
											A2(
												...
												A2(
													_elm_lang$core$Basics_ops['++'],
													'\", \"songUrl\": \"',
													A2(_elm_lang$core$Basics_ops['++'], newSong, '\"}')))))))
						};
					} else {
						return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					}
			...
			case 'AddSongFail':
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			case 'AddSongSuccess':
				var data = A2(_elm_lang$core$Debug$log, 'response', _p3._0);
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			case 'Play':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Main$mediaMessage('{ \"action\": \"play\" }')
				};
			case 'Pause':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Main$mediaMessage('{ \"action\": \"pause\" }')
				};
			case 'VolumeUp':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Main$mediaMessage('{ \"action\": \"volume-up\" }')
				};
			case 'VolumeDown':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Main$mediaMessage('{ \"action\": \"volume-down\" }')
				};
			case 'ReceiveMessage':
				var msg = A2(_elm_lang$core$Json_Decode$decodeString, _user$project$Main$audioDecoder, _p3._0);
				var decoded = A2(_elm_lang$core$Debug$log, 'message', msg);
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			default:
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
		}
...
var _user$project$Main$navbar = A3(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html_Attributes$class('navbar navbar-default navbar-fixed-top')
		]),
	_elm_lang$core$Native_List.fromArray(
		[
			A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('navbar-header navbar-left')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text('Playlistr')
								]))
						])),
					A2(
					_elm_lang$html$Html$div,
												...
												[
													...
													_elm_lang$core$Native_List.fromArray(
														[
															...
															_elm_lang$core$Native_List.fromArray(
																[
																	_elm_lang$html$Html_Attributes$href('/user')
																]),
															_elm_lang$core$Native_List.fromArray(
																[
															...
															_elm_lang$core$Native_List.fromArray(
																[
																	...
																	_elm_lang$core$Native_List.fromArray(
																		[
																			_elm_lang$html$Html_Events$onClick(_user$project$Main$Signout)
																		]),
																	_elm_lang$core$Native_List.fromArray(
																		[
...
var _user$project$Main$Rewind = function (a) {
	return {ctor: 'Rewind', _0: a};
};
var _user$project$Main$ReceiveMessage = function (a) {
	return {ctor: 'ReceiveMessage', _0: a};
};
var _user$project$Main$VolumeDown = {ctor: 'VolumeDown'};
var _user$project$Main$VolumeUp = {ctor: 'VolumeUp'};
var _user$project$Main$Pause = {ctor: 'Pause'};
var _user$project$Main$Play = {ctor: 'Play'};
var _user$project$Main$audioPlayer = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(_user$project$Main$VolumeUp)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('vol+')
					])),
				A2(
				_elm_lang$html$Html$button,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(_user$project$Main$VolumeDown)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('vol-')
...
var _user$project$Main$videoPlayer = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
...
var _user$project$Main$GoLive = {ctor: 'GoLive'};
var _user$project$Main$goLiveLink = A2(
	_elm_lang$html$Html$button,
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html_Attributes$class('btn btn-default'),
			_elm_lang$html$Html_Events$onClick(_user$project$Main$GoLive)
		]),
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html$text('Go Live')
		]));
var _user$project$Main$NextSong = {ctor: 'NextSong'};
var _user$project$Main$AddSong = {ctor: 'AddSong'};
var _user$project$Main$ToggleSongHidden = function (a) {
	return {ctor: 'ToggleSongHidden', _0: a};
};
var _user$project$Main$songEntry = function (song) {
	var extraInfo = song.expanded ? A2(
		_elm_lang$html$Html$ul,
		_elm_lang$core$Native_List.fromArray(
			[
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Basics$toString(song.length))
							])),
						A2(
						_elm_lang$html$Html$div,
						_elm_lang$core$Native_List.fromArray(
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_user$project$Main$ToggleSongHidden(song))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('panel-title pull-left')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(song.info)
							]))
					])),
				playingIcon,
				A2(
...
var _user$project$Main$songArea = function (model) {
	var _p10 = model.selectedPlaylist;
	if (_p10.ctor === 'Nothing') {
		...
		var _p11 = _p10._0;
		return (_elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$List$length(_p11.songs),
			0) > 0) ? A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[]),
			A2(
				_elm_lang$core$List$map,
				function (song) {
					return _user$project$Main$songEntry(song);
				},
				_p11.songs)) : A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(_p11.title)
						])),
					A2(
					_elm_lang$html$Html$div,
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('well well-sm')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text('There\'s nothing here.  Add songs to this playlist above.')
								]))
						]))
				]));
	}
};
var _user$project$Main$contentSection = function (model) {
	var _p12 = model.selectedPlaylist;
	if (_p12.ctor === 'Nothing') {
		...
		if (_elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$List$length(_p14.songs),
			0) > 0) {
			var _p13 = _p14.playlistType;
			if (_p13.ctor === 'Audio') {
				return A2(
					_elm_lang$html$Html$div,
					_elm_lang$core$Native_List.fromArray(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_user$project$Main$audioPlayer(model),
							_user$project$Main$songArea(model)
						]));
			} else {
				return A2(
					_elm_lang$html$Html$div,
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_user$project$Main$videoPlayer(model),
							_user$project$Main$songArea(model)
						]));
			}
		} else {
...
var _user$project$Main$InputSong = function (a) {
	return {ctor: 'InputSong', _0: a};
};
var _user$project$Main$addSongArea = A2(
	_elm_lang$html$Html$div,
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html_Attributes$class('input-group add-song-input')
		]),
	_elm_lang$core$Native_List.fromArray(
		[
			A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$html$Html_Attributes$placeholder('Add song to current playlist'),
					_elm_lang$html$Html_Events$onInput(_user$project$Main$InputSong)
				]),
			_elm_lang$core$Native_List.fromArray(
				[])),
			A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('btn btn-default'),
							_elm_lang$html$Html_Events$onClick(_user$project$Main$AddSong)
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('+')
...
var _user$project$Main$UpdatePlaylistPublicStatus = {ctor: 'UpdatePlaylistPublicStatus'};
var _user$project$Main$UpdatePlaylistPassword = function (a) {
	return {ctor: 'UpdatePlaylistPassword', _0: a};
};
var _user$project$Main$UpdatePlaylistCategory = function (a) {
	return {ctor: 'UpdatePlaylistCategory', _0: a};
};
var _user$project$Main$UpdatePlaylistTitle = function (a) {
	return {ctor: 'UpdatePlaylistTitle', _0: a};
};
var _user$project$Main$UpdatePlaylistType = function (a) {
	return {ctor: 'UpdatePlaylistType', _0: a};
};
var _user$project$Main$CreatePlaylist = {ctor: 'CreatePlaylist'};
var _user$project$Main$TogglePlaylistForm = {ctor: 'TogglePlaylistForm'};
var _user$project$Main$playlistForm = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('playlist-form')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('glyphicon glyphicon-remove pull-right close-playlist-form'),
						_elm_lang$html$Html_Events$onClick(_user$project$Main$TogglePlaylistForm)
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('playlist-form-header')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Create playlist')
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$type$('text'),
								_elm_lang$html$Html_Attributes$class('form-control'),
								_elm_lang$html$Html_Attributes$placeholder('Playlist title'),
								_elm_lang$html$Html_Events$onInput(_user$project$Main$UpdatePlaylistTitle)
							]),
						_elm_lang$core$Native_List.fromArray(
							[])),
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$type$('text'),
								_elm_lang$html$Html_Attributes$class('form-control'),
								_elm_lang$html$Html_Attributes$placeholder('Playlist category'),
								_elm_lang$html$Html_Events$onInput(_user$project$Main$UpdatePlaylistCategory)
							]),
						_elm_lang$core$Native_List.fromArray(
							[]))
					])),
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$type$('text'),
						_elm_lang$html$Html_Attributes$class('form-control'),
						_elm_lang$html$Html_Attributes$placeholder('Password (leave blank for none)'),
						_elm_lang$html$Html_Events$onInput(_user$project$Main$UpdatePlaylistPassword)
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('radio-inline')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$html$Html_Attributes$checked(model.newPlaylist.$public),
										_elm_lang$html$Html_Events$onClick(_user$project$Main$UpdatePlaylistPublicStatus)
									]),
								_elm_lang$core$Native_List.fromArray(
									[])),
								_elm_lang$html$Html$text('Public submissions')
							]))
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('type-radio')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
							...
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$html$Html_Attributes$name('type'),
										_elm_lang$html$Html_Attributes$checked(
										_elm_lang$core$Native_Utils.eq(model.newPlaylist.playlistType, _user$project$Main$Audio)),
										_elm_lang$html$Html_Events$onClick(
										_user$project$Main$UpdatePlaylistType(_user$project$Main$Audio))
									]),
								_elm_lang$core$Native_List.fromArray(
									[])),
							...
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$html$Html_Attributes$name('type'),
										_elm_lang$html$Html_Attributes$checked(
										_elm_lang$core$Native_Utils.eq(model.newPlaylist.playlistType, _user$project$Main$Video)),
										_elm_lang$html$Html_Events$onClick(
										_user$project$Main$UpdatePlaylistType(_user$project$Main$Video))
									]),
								_elm_lang$core$Native_List.fromArray(
									[])),
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_Attributes$class('btn btn-primary create-playlist-button'),
						_elm_lang$html$Html_Attributes$id('create_playist'),
						_elm_lang$html$Html_Events$onClick(_user$project$Main$CreatePlaylist)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
...
var _user$project$Main$playlistCreator = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('playlist-modal')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('btn btn-primary show-playlist-form'),
						_elm_lang$html$Html_Events$onClick(_user$project$Main$TogglePlaylistForm)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('New Playlist')
					])),
				model.modalShowing ? A2(_elm_lang$html$Html_Lazy$lazy, _user$project$Main$playlistForm, model) : A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[]),
				_elm_lang$core$Native_List.fromArray(
...
var _user$project$Main$SelectPlaylist = function (a) {
...
var _user$project$Main$playlist = F2(
	function (selectedPlaylist, playlist) {
		var glyphicon = function () {
			var _p15 = playlist.playlistType;
			if (_p15.ctor === 'Audio') {
		...
		var selected = _elm_lang$core$Native_Utils.eq(playlist.title, selectedPlaylist) ? 'selected' : '';
		return A2(
			_elm_lang$html$Html$button,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('list-group-item playlist-selector pull-left'),
					_elm_lang$html$Html_Attributes$id(playlist.title),
					_elm_lang$html$Html_Attributes$type$('button'),
					_elm_lang$html$Html_Events$onClick(
					_user$project$Main$SelectPlaylist(playlist))
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text(playlist.title),
					A2(
					_elm_lang$html$Html$span,
					_elm_lang$core$Native_List.fromArray(
						[
							...
							A2(
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									glyphicon,
									A2(_elm_lang$core$Basics_ops['++'], ' playlist-span ', selected))))
						]),
					_elm_lang$core$Native_List.fromArray(
						[]))
				]));
	});
var _user$project$Main$playlistSidebar = function (model) {
	var _p16 = _elm_lang$core$List$length(model.playlists);
	if (_p16 === 0) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							A2(_elm_lang$html$Html_Lazy$lazy, _user$project$Main$playlistCreator, model),
							_elm_lang$html$Html$text('There\'s nothing here yet')
						]))
				]));
	} else {
		var playlists = function () {
			var _p17 = model.selectedPlaylist;
			if (_p17.ctor === 'Nothing') {
				return A2(
					_elm_lang$core$List$map,
					function (pl) {
						return A2(_user$project$Main$playlist, '', pl);
					},
					model.playlists);
			} else {
				return A2(
					_elm_lang$core$List$map,
					function (pl) {
						return A2(_user$project$Main$playlist, _p17._0.title, pl);
					},
					model.playlists);
			}
		}();
		var lazyModal = A2(_elm_lang$html$Html_Lazy$lazy, _user$project$Main$playlistCreator, model);
		var children = A2(_elm_lang$core$List_ops['::'], lazyModal, playlists);
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$id('top-section')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[_user$project$Main$addSongArea])),
								A2(
								_elm_lang$html$Html$div,
								_elm_lang$core$Native_List.fromArray(
									[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										A2(_elm_lang$html$Html_Lazy$lazy, _user$project$Main$audioPlayer, model)
									]))
							])),
						A2(
						_elm_lang$html$Html$div,
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$class('col-md-3 sidebar-col')
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										A2(_elm_lang$html$Html_Lazy$lazy, _user$project$Main$playlistSidebar, model)
									])),
								A2(
								_elm_lang$html$Html$div,
								_elm_lang$core$Native_List.fromArray(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html_Attributes$id('playlist_area')
											]),
										_elm_lang$core$Native_List.fromArray(
											[
												A2(
												...
												_elm_lang$core$Native_List.fromArray(
													[
														...
														_elm_lang$core$Native_List.fromArray(
															[
																_user$project$Main$exportPlaylistLink(model)
															]))
													])),
												A2(
												_elm_lang$html$Html$div,
												...
												_elm_lang$core$Native_List.fromArray(
													[])),
												A2(_elm_lang$html$Html_Lazy$lazy, _user$project$Main$contentSection, model)
											]))
									]))
							]))
					]))
...
var _user$project$Main$GetPlaylistsSuccess = function (a) {
	return {ctor: 'GetPlaylistsSuccess', _0: a};
};
var _user$project$Main$GetPlaylistsFail = function (a) {
	return {ctor: 'GetPlaylistsFail', _0: a};
};
var _user$project$Main$getPlaylists = A3(
	_elm_lang$core$Task$perform,
	_user$project$Main$GetPlaylistsFail,
	_user$project$Main$GetPlaylistsSuccess,
	_evancz$elm_http$Http$getString(
		A2(_elm_lang$core$Basics_ops['++'], _user$project$Main$serverUrl, '/playlist')));
var _user$project$Main$initialModel = {
	ctor: '_Tuple2',
	_0: {
		playlists: _elm_lang$core$Native_List.fromArray(
			[]),
		selectedPlaylist: _elm_lang$core$Maybe$Nothing,
		currentPlaytime: 0.0,
		paused: true,
	...
	_1: _user$project$Main$getPlaylists
};
var _user$project$Main$SocketMessage = function (a) {
...
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				A2(_elm_lang$websocket$WebSocket$listen, _user$project$Main$socketServer, _user$project$Main$SocketMessage),
				_user$project$Main$sendMessage(_user$project$Main$ReceiveMessage)
			]));
};
